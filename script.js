...
const projects = [
  {
    ...
    listItems: ['Converge and Create', 'Frontend Dev', 2023],
  ...
  },
  {
    ...
    listItems: ['Super Sticky Notes', 'Frontend Dev', 2023],
  ...
  },
  {
    ...
    alt: 'Green groceries',
    name: 'Penny Planner',
    listItems: ['Penny Planner', 'Full Stack Dev', 2015],
    ...
    technologies: ['Ruby', 'CSS', 'Ruby on Rails'],
    button: 'See Project',
    popupBtn1: 'See Live <i class="fa-solid fa-arrow-up-right-from-square"></i>',
    popupBtn2: 'See Source <i class="fa-brands fa-github"></i>',
    popupBtn1Link: 'https://github.com/Nasirkhan294/penny_planner',
    popupBtn2Link: 'https://penny-planner.onrender.com/',
  },
  {
    image: 'images/room-rental.png',
    alt: 'A room picture with details',
    name: 'Room Rental',
    listItems: ['Room Rental', 'Lead Developer', 2018],
    ...
    technologies: ['React', 'Tailwind', 'Ruby on Rails'],
    button: 'See Project',
    popupBtn1: 'See Live <i class="fa-solid fa-arrow-up-right-from-square"></i>',
    popupBtn2: 'See Source <i class="fa-brands fa-github"></i>',
    popupBtn1Link: 'https://github.com/Nasirkhan294/room-rental-front-end',
    popupBtn2Link: 'https://room-rental-blond.vercel.app/',
  },
];
